...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3>
                {{ ucwords(t('Clients')) }}
                <a class="btn btn-success float-end" href="{{ route('admin.clients.create') }}">
                    <i class="cil-plus"></i>
                    {{ ucwords(t('add new')) }}
                </a>
            ...
            <div class="card-toolbar search-section d-none">
                <form action="{{ route('admin.clients.index') }}" method="get" id="filter_form">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
        ...
        <div class="card-body">
            <div class="table-responsive clients-content">
                @include('admin.clients.table', ['clients' => $clients])
            </div>
        </div>
    ...
    <script>
        $('#filter_form').on('submit', function(event) {
            ...
            $.ajax({
                ...
                $('.clients-content').empty().append(response.data)
